...
class Pengadaan_habis_pakai extends CI_Controller {
 	protected  $name = 'Pengadaan habis pakai'; 
    protected  $model = 'umum/persediaan-habis-pakai/Rpengadaanhabispakai_model';
 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'Persediaan Habis Pakai'; 
 	protected  $breadcrumb3 = 'Pengadaan Habis Pakai'; 
	...
	public function index(){
		permissions('melihat-data-pengadaan-habis-pakai');
		$urlnow = uri_string();
		$data = array(
	...
	public function actiontable($id){
		if(accessperm('melihat-data-pengadaan-habis-pakai')){
		...
		if(accessperm('merubah-data-pengadaan-habis-pakai')){
		...
		if(accessperm('menghapus-data-pengadaan-habis-pakai')){
	...
	public function add(){
		permissions('menambahkan-data-pengadaan-habis-pakai');
	...
	public function edit($id){
		permissions('merubah-data-pengadaan-habis-pakai');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-pengadaan-habis-pakai');
