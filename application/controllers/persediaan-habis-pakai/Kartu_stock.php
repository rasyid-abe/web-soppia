...
class Kartu_stock extends CI_Controller {
 	protected  $name = 'Kartu stock'; 
    protected  $model = 'umum/persediaan-habis-pakai/Rkartustok_model';
 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'Persediaan Habis Pakai'; 
 	protected  $breadcrumb3 = 'Kartu Stock'; 
	...
	public function index(){
		permissions('melihat-data-kartu-stock');
		$urlnow = uri_string();
		$data = array(
	...
	public function actiontable($id){
		if(accessperm('melihat-data-kartu-stock')){
		...
		if(accessperm('merubah-data-kartu-stock')){
		...
		if(accessperm('menghapus-data-kartu-stock')){
	...
	public function add(){
		permissions('menambahkan-data-kartu-stock');
	...
	public function edit($id){
		permissions('merubah-data-kartu-stock');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-kartu-stock');
