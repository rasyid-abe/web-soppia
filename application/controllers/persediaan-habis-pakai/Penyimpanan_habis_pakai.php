...
class Penyimpanan_habis_pakai extends CI_Controller {
 	protected  $name = 'Penyimpanan habis pakai'; 
    protected  $model = 'umum/persediaan-habis-pakai/Rpenyimpananhabispakai_model';
 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'Persediaan Habis Pakai'; 
 	protected  $breadcrumb3 = 'Penyimpanan Habis Pakai'; 
	...
	public function index(){
		permissions('melihat-data-penyimpanan-habis-pakai');
		$urlnow = uri_string();
		$data = array(
	...
	public function actiontable($id){
		if(accessperm('melihat-data-penyimpanan-habis-pakai')){
		...
		if(accessperm('merubah-data-penyimpanan-habis-pakai')){
		...
		if(accessperm('menghapus-data-penyimpanan-habis-pakai')){
	...
	public function add(){
		permissions('menambahkan-data-penyimpanan-habis-pakai');
	...
	public function edit($id){
		permissions('merubah-data-penyimpanan-habis-pakai');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-penyimpanan-habis-pakai');
