...
class Jenis_pelatihan_i extends CI_Controller {
 	protected  $name = 'Jenis pelatihan i'; 
    protected  $model = 'referensi/jenis-pelatihan/Rjenispelatihan1_model'; 
	...
	public function index(){
		permissions('melihat-data-jenis-pelatihan-i');
		$urlnow = uri_string();
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
			'breadcrumb3'=>'Jenis Pelatihan I',
			'titlepage'=>'Jenis Pelatihan I',
			'subtitlepage'=>'Data Jenis Pelatihan I',
			'titlebox'=>'Manage Jenis Pelatihan I',
	...
	public function getdata(){
        ...
        foreach ($list as $field) {
            ...
            $row = array();
            $row[] = $no;
            $row[] = $field->Desc_JnsPelatihan1;
            $row[] = $this->actiontable($field->Kd_JnsPelatihan1);
	...
	public function actiontable($id){
		if(accessperm('melihat-data-jenis-pelatihan-i')){
		...
		if(accessperm('merubah-data-jenis-pelatihan-i')){
		...
		if(accessperm('menghapus-data-jenis-pelatihan-i')){
	...
	public function add(){
		permissions('menambahkan-data-jenis-pelatihan-i');
		...
		$data = array(
			...
			'titlepage'=>'Jenis Pelatihan I',
			'subtitlepage'=>'Data Jenis Pelatihan I',
			'titlebox'=>'Add Jenis Pelatihan I',
			'urlback'=>$this->db->where("url",$urlnow)->get("menu")
		);
	...
	public function store(){	
		...
		$this->form_validation->set_rules('name', 'Name', 'trim|required|is_unique[ref_jenispelatihan1.Desc_JnsPelatihan1]|xss_clean');
		if ($this->form_validation->run() == FALSE) {
			$this->session->set_flashdata(array( 'error'=>validation_errors(),'oldinput'=> $this->security->xss_clean(html_escape($this->input->post())) ));
			redirect(base_url('jenis-pelatihan/'.url_title(strtolower($this->name)).'/add'));
		}else{
			$data = array(
				'Desc_JnsPelatihan1'=>$name,
			);
	...
	public function edit($id){
		permissions('merubah-data-jenis-pelatihan-i');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
			...
			'titlepage'=>'Jenis Pelatihan I',
			'subtitlepage'=>'Data Jenis Pelatihan I',
			'titlebox'=>'Edit Jenis Pelatihan I',
	...
	public function delete($id){
		permissions('menghapus-data-jenis-pelatihan-i');
