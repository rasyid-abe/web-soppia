...
class Jenis_pelatihan_ii extends CI_Controller {
 	protected  $name = 'Jenis pelatihan ii'; 
    protected  $model = 'referensi/jenis-pelatihan/Rjenispelatihan2_model'; 
	...
	public function index(){
		permissions('melihat-data-jenis-pelatihan-ii');
		$urlnow = uri_string();
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
			'breadcrumb3'=>'Jenis Pelatihan II',
			'titlepage'=>'Jenis Pelatihan II',
			'subtitlepage'=>'Data Jenis Pelatihan II',
			'titlebox'=>'Manage Jenis Pelatihan II',
	...
	public function getdata(){
        ...
        foreach ($list as $field) {
            ...
            $row = array();
            $row[] = $no;
            $row[] = $field->Desc_JnsPelatihan2;
            $row[] = $this->actiontable($field->Kd_JnsPelatihan2);
	...
	public function actiontable($id){
		if(accessperm('melihat-data-jenis-pelatihan-ii')){
		...
		if(accessperm('merubah-data-jenis-pelatihan-ii')){
		...
		if(accessperm('menghapus-data-jenis-pelatihan-ii')){
	...
	public function add(){
		permissions('menambahkan-data-jenis-pelatihan-ii');
		...
		$data = array(
			...
			'titlepage'=>'Jenis Pelatihan II',
			'subtitlepage'=>'Data Jenis Pelatihan II',
			'titlebox'=>'Add Jenis Pelatihan II',
			'urlback'=>$this->db->where("url",$urlnow)->get("menu")
		);
	...
	public function store(){	
		...
		$this->form_validation->set_rules('name', 'Name', 'trim|required|is_unique[ref_jenispelatihan2.Desc_JnsPelatihan2]|xss_clean');
		if ($this->form_validation->run() == FALSE) {
			$this->session->set_flashdata(array( 'error'=>validation_errors(),'oldinput'=> $this->security->xss_clean(html_escape($this->input->post())) ));
			redirect(base_url('jenis-pelatihan/'.url_title(strtolower($this->name)).'/add'));
		}else{
			$data = array(
				'Desc_JnsPelatihan2'=>$name,
			);
	...
	public function edit($id){
		permissions('merubah-data-jenis-pelatihan-ii');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
			...
			'titlepage'=>'Jenis Pelatihan II',
			'subtitlepage'=>'Data Jenis Pelatihan II',
			'titlebox'=>'Edit Jenis Pelatihan II',
	...
	public function delete($id){
		permissions('menghapus-data-jenis-pelatihan-ii');
