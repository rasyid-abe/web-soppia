...
class Pengumuman_hasil extends CI_Controller {
    ...
    protected  $model = 'pelatihan/cbt/Rhasil_model'; 
	...
	public function index(){
		permissions('melihat-data-pengumuman-hasil-cbt');
		$urlnow = uri_string();
		$data = array(
			...
			'titlebox'=>'Manage Pengumuman Hasil',
	...
	public function actiontable($id){
		if(accessperm('melihat-data-pengumuman-hasil-cbt')){
		...
		if(accessperm('merubah-data-pengumuman-hasil-cbt')){
		...
		if(accessperm('menghapus-data-pengumuman-hasil-cbt')){
	...
	public function add(){
		permissions('menambahkan-data-pengumuman-hasil-cbt');
	...
	public function edit($id){
		permissions('merubah-data-pengumuman-hasil-cbt');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-pengumuman-hasil-cbt');
