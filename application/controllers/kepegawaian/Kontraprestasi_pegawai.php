...
class Kontraprestasi_pegawai extends CI_Controller {
 	protected  $name = 'Kontraprestasi pegawai'; 
    protected  $model = 'kepegawaian/kepegawaian/Rkontraprestasipegawai_model';
 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'Kepegawaian'; 
 	protected  $breadcrumb3 = 'Kontraprestasi Pegawai'; 
	...
	public function index(){
		permissions('melihat-data-kontraprestasi-pegawai');
		$urlnow = uri_string();
		$data = array(
	...
	public function getdata(){
        ...
        foreach ($list as $field) {
            ...
            $row[] = $this->actiontable($field->id_kontraprestasi);
            $data[] = $row;
	    }
	...
	public function actiontable($id){
		if(accessperm('melihat-data-kontraprestasi-pegawai')){
		...
		if(accessperm('merubah-data-kontraprestasi-pegawai')){
		...
		if(accessperm('menghapus-data-kontraprestasi-pegawai')){
	...
	public function add(){
		permissions('menambahkan-data-kontraprestasi-pegawai');
...
// 		$this->form_validation->set_rules('keterangan', 'Keterangan', 'trim|xss_clean');
	...
	public function edit($id){
		permissions('merubah-data-kontraprestasi-pegawai');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-kontraprestasi-pegawai');
