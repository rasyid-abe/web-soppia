...
class Kartu_eksploitasi_ruangan extends CI_Controller {
 	protected  $name = 'Kartu eksploitasi ruangan'; 
    protected  $model = 'umum/pengelolaan-ruangan/Rkatrueksploitasiruangan_model';
 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'Pengelolaan Ruangan'; 
 	protected  $breadcrumb3 = 'Kartu Eksploitasi Ruangan'; 
	...
	public function index(){
		permissions('melihat-data-kartu-eksploitasi-ruangan');
		$urlnow = uri_string();
		$data = array(
	...
	public function actiontable($id){
		if(accessperm('melihat-data-kartu-eksploitasi-ruangan')){
		...
		if(accessperm('merubah-data-kartu-eksploitasi-ruangan')){
		...
		if(accessperm('menghapus-data-kartu-eksploitasi-ruangan')){
	...
	public function add(){
		permissions('menambahkan-data-kartu-eksploitasi-ruangan');
	...
	public function edit($id){
		permissions('merubah-data-kartu-eksploitasi-ruangan');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-kartu-eksploitasi-ruangan');
