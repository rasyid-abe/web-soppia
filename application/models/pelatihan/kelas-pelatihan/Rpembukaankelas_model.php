...
class Rpembukaankelas_model extends CI_Model {
	var $table = 'trm_pembukaankelas_n_angkatan'; 
    var $column_order =array(null,'trm_pembukaankelas_n_angkatan.DescBebas_Kelas_n_Angkatan','trm_pembukaankelas_n_angkatan.nomor_kelas','mst_proformakontrak.No_ProformaKontrak','mst_dokbukaklsreguler.No_Klsreguler','mst_jenispelatihan.Desc_JenisPelatihan','mst_pershinstansi.Desc_PershInstansi'); 
    var $column_search = array('trm_pembukaankelas_n_angkatan.DescBebas_Kelas_n_Angkatan','trm_pembukaankelas_n_angkatan.nomor_kelas','mst_proformakontrak.No_ProformaKontrak','mst_dokbukaklsreguler.No_Klsreguler','mst_jenispelatihan.Desc_JenisPelatihan','mst_pershinstansi.Desc_PershInstansi'); 
