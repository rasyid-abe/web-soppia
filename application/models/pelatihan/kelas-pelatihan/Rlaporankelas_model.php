...
class Rlaporankelas_model extends CI_Model {
    var $table = 'trm_pembukaankelas_n_angkatan'; 
    var $column_order = array(null,'Desc_JenisPelatihan','Desc_PershInstansi','Desc_KotaTraining','Desc_Piagam_Sertifikat','DescBaku_Kelas_n_Angkatan','DescBebas_Kelas_n_Angkatan','LokasiPenyelenggaraan'); 
    var $column_search = array('Desc_JenisPelatihan','Desc_PershInstansi','Desc_KotaTraining','Desc_Piagam_Sertifikat','DescBaku_Kelas_n_Angkatan','DescBebas_Kelas_n_Angkatan','LokasiPenyelenggaraan'); 
    var $order = array('Id_Kelas_n_Angkatan' => 'asc'); 
