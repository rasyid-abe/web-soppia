...
class Rcalonpeserta_model extends CI_Model {
 
    var $table = 'mst_peserta'; //nama tabel dari database
    var $column_order = array(null,'', 'ABS(NIPP)','NamaLengkap_TanpaGelar','NamaPershInstansi','Entry_Date'); 
    var $column_search = array('NIPP','NamaLengkap_TanpaGelar','NamaPershInstansi','Entry_Date'); 
    var $order = array('Entry_Date' => 'DESC'); // default order 
