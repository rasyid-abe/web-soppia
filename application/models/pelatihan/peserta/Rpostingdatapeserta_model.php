...
class Rpostingdatapeserta_model extends CI_Model {
 
    var $table = 'mst_peserta'; //nama tabel dari database
    var $column_order = array(null, '','ABS(NIPP)','mst_peserta.NamaLengkap_TanpaGelar','mst_peserta.NamaPershInstansi'); 
    var $column_search = array('mst_peserta.NIPP','mst_peserta.NamaLengkap_TanpaGelar','mst_peserta.NamaPershInstansi'); 
    var $order = array('ABS(NIPP)' => 'ASC'); // default order 
