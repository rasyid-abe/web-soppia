...
class Rpengantaranpermohonan_model extends CI_Model {
	var $table = 'mst_peserta_dgn_ds_qia'; 
    var $column_order = array(null,'ABS(mst_peserta.NIPP)','mst_peserta.NamaLengkap_TanpaGelar','mst_peserta.NamaPershInstansi','','mst_peserta_dgn_ds_qia.Tgl_Kirim_CV'); 
    var $column_search = array('ABS(mst_peserta.NIPP)','mst_peserta.NamaLengkap_TanpaGelar','mst_peserta.NamaPershInstansi','','mst_peserta_dgn_ds_qia.Tgl_Kirim_CV'); 
