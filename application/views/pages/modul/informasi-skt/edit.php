...
<section class="content">
  ...
  <div class="row ">
      <div class="col-md-12"> 
        ...
        <div class="box-body">
          <form action="<?=base_url($this->uri->segment(1)."/update/".$dtdefault->Id_Saran_Komplain)?>" method="POST">
            ...
            ?>
              ...
              <div class="form-group col-sm-12">
                <div class="col-sm-2">
                  <label>Isi TL yg sudah dilakukan</label>
                </div>
                <div class="col-sm-10">
                  <textarea class="form-control" name="Isi_TL_yg_sudah_dilakukan" id="Isi_TL_yg_sudah_dilakukan" placeholder="Isi_TL_yg_sudah_dilakukan" ><?=$tl1?></textarea>
                </div>
              </div>
              
              <div class="form-group col-sm-12">
                <div class="col-sm-2">
                  <label>Isi TL yg akan dilakukan</label>
                </div>
                <div class="col-sm-10">
                  <textarea class="form-control" name="Isi_TL_yg_akan_dilakukan" id="Isi_TL_yg_akan_dilakukan" placeholder="Isi_TL_yg_akan_dilakukan" ><?=$tl2?></textarea>
                </div>
              </div>
