    ...
    <div class="box-body">
      <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/store")?>" method="POST">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-6">
            Nama Sertifikasi<br/>
            <input type="text" class="form-control" name="Desc_Sertifikasi" id="Desc_Sertifikasi" placeholder="Desc Sertifikasi" value="<?=$this->session->flashdata('oldinput')['Desc_Sertifikasi']?>" >
          </div>
        </div>
          ...
          <div class="col-sm-6">
            ...
            <select name="FKd_Jns_Sertifikasi1" class="form-control select2" style="width: 100%;">
              ...
              foreach ($fkd_jns_sertifikasi1->result() as $fkd1) {
                $slc = ($this->session->flashdata('oldinput')['fkd_jns_sertifikasi1']==$fkd1->Kd_Jns_Sertifikasi1)? 'selected':'';
              ?>
          ...
          <div class="col-sm-6">
            ...
            <select name="FKd_Jns_Sertifikasi2" class="form-control select2" style="width: 100%;">
              ...
              foreach ($fkd_jns_sertifikasi2->result() as $fkd2) {
                $slc = ($this->session->flashdata('oldinput')['fkd_jns_sertifikasi2']==$fkd2->Kd_Jns_Sertifikasi2)? 'selected':'';
              ?>
