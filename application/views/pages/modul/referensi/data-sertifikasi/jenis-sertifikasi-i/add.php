      ...
      <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/store")?>" method="POST">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-12">
            ...
            <input type="text" class="form-control" name="Desc_Jns_Sertifikasi1" id="Desc_Jns_Sertifikasi1" placeholder="Desc Jenis Sertifikasi I"  value="<?=$this->session->flashdata('oldinput')['name']?>" >
          </div>
        </div>
