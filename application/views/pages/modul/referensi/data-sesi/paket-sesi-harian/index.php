  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-paket-sesi-harian')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-paket-sesi-harian')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-paket-sesi-harian')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
