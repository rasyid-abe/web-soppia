      ...
      <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/store")?>" method="POST">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-12">
            ...
            <input type="text" class="form-control" name="Desc_Paket_Sesi_Harian" id="Desc_Paket_Sesi_Harian" placeholder="Description"  value="<?=$this->session->flashdata('oldinput')['Desc_Paket_Sesi_Harian']?>" >
          </div>
        </div>
