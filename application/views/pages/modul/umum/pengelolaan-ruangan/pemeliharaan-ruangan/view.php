  ...
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#tab_2" data-toggle="tab"><b>Informasi Pemeliharaan</b></a></li>
    </ul>
      ...
      <div class="tab-pane" id="tab_2">
        <table class="table table-bordered table-striped" style="width: 100%">
        	...
        	<tr>
        		<td valign="top" style="color:#00008B">Keterangan</td>
        		<td valign="top">:</td>
        		<td valign="top" style="color:#9900cc"><?=$dtdefault->alasan_perbaikan?></td>
        	</tr>	
        	<tr>
        		<td valign="top" style="color:#00008B">Biaya</td>
        		<td valign="top">:</td>
        		<td valign="top" style="color:#9900cc">Rp. <?=number_format($dtdefault->biaya)?></td>
        	</tr>	
		</table>
      </div>
      <!-- /.tab-pane -->
