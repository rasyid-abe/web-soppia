      ...
      <div class="col-md-12"> 
        <div class="box box-warning">
          <div class="box-header with-border">
            ...
            <div class="box-body">
              <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/update/".$dtdefault->id_pemakaian)?>" method="POST">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" name="keterangan_pakai" placeholder="Keterangan Pemakaian"><?=$dtdefault->keterangan_pakai?></textarea>
                  </div>
                </div>
