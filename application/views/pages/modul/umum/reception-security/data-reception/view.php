	...
	if($dtdefault->num_rows() > 0){
		...
		<table class="table table-bordered table-striped" style="width: 100%">
			...
			<tr>
				...
				<td valign="top">:</td>
				<td valign="top" style="color:#9900cc"><?=$dtdefault->jadwal_senin_reception ?></td>
			</tr>
			<tr>
				<td valign="top" style="color:#00008B">Jadwal Selasa</td>
				<td valign="top">:</td>
				<td valign="top" style="color:#9900cc"><?=$dtdefault->jadwal_selasa_reception?></td>
			</tr>
			<tr>
				<td valign="top" style="color:#00008B">Jadwal Rabu</td>
				<td valign="top">:</td>
				<td valign="top" style="color:#9900cc"><?=$dtdefault->jadwal_rabu_reception?></td>
			</tr>
			<tr>
				<td valign="top" style="color:#00008B">Jadwal Kamis</td>
				<td valign="top">:</td>
				<td valign="top" style="color:#9900cc"><?=$dtdefault->jadwal_kamis_reception?></td>
			</tr>
			<tr>
				<td valign="top" style="color:#00008B">Jadwal Jum'at</td>
				<td valign="top">:</td>
				<td valign="top" style="color:#9900cc"><?=$dtdefault->jadwal_jumat_reception?></td>
			</tr>
			<tr>
				<td valign="top" style="color:#00008B">Jadwal Sabtu</td>
				<td valign="top">:</td>
				<td valign="top" style="color:#9900cc"><?=$dtdefault->jadwal_sabtu_reception?></td>
			</tr>
			<tr>
				<td valign="top" style="color:#00008B">Jadwal Minggu</td>
				<td valign="top">:</td>
				<td valign="top" style="color:#9900cc"><?=$dtdefault->jadwal_minggu_reception?></td>
			</tr>
		</table>
		<?php
	} else {
