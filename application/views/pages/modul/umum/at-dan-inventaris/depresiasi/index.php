  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-depresiasi')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-depresiasi')){ ?>        
       ...
       <thead>
        ...
        <tbody>
         <tr>
          ...
          <td>100.000.000</td>
          <td>
            <a href='<?= base_url("at-dan-inventaris/depresiasi/view/4646156")?>' class='btn btn-xs btn-primary view-data' data-toggle='tooltip' title='View Data'> <i class='fa fa-search-plus'></i> View </a> 
            <a href='<?= base_url("at-dan-inventaris/depresiasi/edit/4646156")?>' class='btn btn-xs btn-warning' data-toggle='tooltip'title='Edit Data'> <i class='fa fa-pencil-square'></i> Edit </a> 
            <a href='""' class='btn btn-xs btn-danger delete-data' data-toggle='tooltip' title='Delete Data'> <i class='fa fa-trash'></i> Delete </a>
          </td>
        </tr>
        </tbody>
      </table>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-depresiasi')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
