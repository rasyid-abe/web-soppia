  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
       <!--  <?php if(accessperm('mengimport-data-kartu-eksploitasi')){ ?>        
       ...
       <thead>
        ...
        <tbody>
         <tr>
          ...
          <td>4646156</td>
          <td>Inventaris</td>
          <td>06 januari 2018</td>
          <td>01 januari 2018</td>
          <td>
            <a href='<?= base_url("at-dan-inventaris/kartu-eksploitasi/view/4646156")?>' class='btn btn-xs btn-primary view-data' data-toggle='tooltip' title='View Data'> <i class='fa fa-search-plus'></i> View </a>
          </td>
        </tr>
        </tbody>
      </table>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-kartu-eksploitasi')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
