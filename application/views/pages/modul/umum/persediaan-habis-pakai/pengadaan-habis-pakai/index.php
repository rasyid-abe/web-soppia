  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pengadaan-habis-pakai')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-pengadaan-habis-pakai')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pengadaan-habis-pakai')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
