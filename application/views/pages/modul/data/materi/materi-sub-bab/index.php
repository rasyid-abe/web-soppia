  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-materi-sub-bab')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-materi-sub-bab')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-materi-sub-bab')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
      ...
      <?php } ?>
      "ajax": {
        "url": "<?php echo site_url($this->uri->segment(1).'/'.$this->uri->segment(2).'/getdata')?>",
        "type": "POST",
