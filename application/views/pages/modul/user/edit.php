...
<section class="content">
  ...
  <div class="box box-warning">
    ...
    <div class="box-body">
      <form action="<?=base_url($this->uri->segment(1)."/update/".$user->iduser)?>" method="POST">
        ...
        <div class="form-group col-sm-6">
          <div class="col-sm-12">
            Nama Lengkap<br/>
            <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Fullname" value="<?=$detailuser->fullname?>" >
          </div>
        </div>
        <div class="form-group col-sm-6">
          <div class="col-sm-12">
          ...
          <div class="col-sm-12">
            ...
            <select name="role" class="form-control select2" style="width: 100%;">
              ...
              foreach ($role->result() as $rl) {
                if(is_admin()){
                    $slc = ($roleuser->idrole ==$rl->idrole)? 'selected':'';
                    ?>
                  ...
                  if(is_adminadmin()){
                    if($rl->is_khusus != '1'){
                       ...
                       */ $slc = ($roleuser->idrole ==$rl->idrole)? 'selected':'';
                        ...
                        <?php
                      /*}else{
                          $slc = ($roleuser->idrole ==$rl->idrole)? 'selected':' readonly disabled';
                          ?>
                          <option value="<?=$rl->idrole?>" <?=$slc?> ><?=$rl->name?></option>
                          <?php
                      }   */                  
