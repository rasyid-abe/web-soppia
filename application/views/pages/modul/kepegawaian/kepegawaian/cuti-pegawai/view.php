  ...
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#tab_2" data-toggle="tab"><b>Informasi Cuti</b></a></li>
    </ul>
      ...
      <div class="tab-pane" id="tab_2">
        <table class="table table-bordered table-striped" style="width: 100%">
			<tr>
        		...
        		<td valign="top">:</td>
        		<td valign="top" style="color:#9900cc"><?=tgl_indo($dtdefault->mulai_cuti)?></td>
        	</tr>	
        	<tr>
        		<td valign="top" style="color:#00008B">Tanggal Selesai</td>
        		<td valign="top">:</td>
        		<td valign="top" style="color:#9900cc"><?=tgl_indo($dtdefault->selesai_cuti)?></td>
        	</tr>	
        	<tr>
        	...
        	<tr>
        		<td valign="top" style="color:#00008B">Status</td>
        		<td valign="top">:</td>
        		<td valign="top" style="color:#9900cc"><?=$dtdefault->persetujuan?></td>
        	</tr>	
        	<tr>
