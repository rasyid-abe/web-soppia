      ...
      <div class="col-md-12"> 
        <div class="box box-warning">
          <div class="box-header with-border">
            ...
            <div class="box-body">
              <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/update/".$dtdefault->id_cuti)?>" method="POST">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="mulai_cuti" placeholder="Tanggal Mulai" value="<?=$dtdefault->mulai_cuti?>" >
                  </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="selesai_cuti" placeholder="Tanggal Selesai" value="<?=$dtdefault->selesai_cuti?>" >
                  </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <select name="persetujuan" class="form-control select2" style="width: 100%;">
                      <?php
                           $slc1 = ($dtdefault->persetujuan=="Disetuji")? 'selected':'';
                           $slc2 = ($dtdefault->persetujuan=="Tidak Disetuji")? 'selected':'';
                           $slc3 = ($dtdefault->persetujuan==null)? 'selected':'';
                        ?>
                    <option value="" <?=$slc3?>>Pilih</option>                  
                    <option <?=$slc1?>>Disetuji</option>                  
                    <option <?=$slc2?>>Tidak Disetuji</option>                
                    </select>
                  </div>
                </div>
