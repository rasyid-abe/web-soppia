        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control" name="mulai_cuti" placeholder="Tanggal Mulai Cuti" value="<?=$this->session->flashdata('oldinput')['mulai_cuti']?>" >
              </div>
            </div>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control" name="selesai_cuti" placeholder="Tanggal Selesai Cuti" value="<?=$this->session->flashdata('oldinput')['selesai_cuti']?>" >
              </div>
            </div>
