...
<section class="content">
  ...
  <div class="box box-warning">
    ...
    <div class="box-body">
       ...
       <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/update/".$dtdefault->id_bpjs_ketenagakerjaan)?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-6" style="color:#00008B">
           Nama Pegawai
            <br/>
            <input type="text" class="form-control" id="pegawai"  value="<?=$dtdefault->nama_pegawai?>"  readonly>
          </div>
        </div>
        ...
        <div class="form-group col-sm-12">
         ...
         Jabatan
            <br/>
            <input type="text" class="form-control" id="jabatan"   value="<?=$dtdefault->jabatan?>"   readonly>
          </div>
        </div>
         ...
         No BPJS
            <br/>
            <input type="text" class="form-control" name="no_bpjs" id="no_bpjs_ketenagakerjaan"   value="<?=$dtdefault->no_bpjs?>"  >
          </div>
        </div>
        ...
        Masa Jabatan
            <br/>
            <input type="number" class="form-control" name="masa_jabatan" id="masa_kerja"  value="<?=$dtdefault->masa_jabatan?>"   >
          </div>
        </div>
