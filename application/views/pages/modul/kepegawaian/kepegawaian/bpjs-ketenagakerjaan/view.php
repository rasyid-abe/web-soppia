  ...
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#tab_2" data-toggle="tab"><b>Informasi Bpjs Ketenagakerjaan</b></a></li>
    </ul>
    <div class="tab-content">
      ...
      <div class="tab-pane" id="tab_2">
        <table class="table table-bordered table-striped" style="width: 100%">
			<tr>
        		<td valign="top" style="color:#00008B" width="200px">No BPJS</td>
        		<td valign="top">:</td>
        		<td valign="top" style="color:#9900cc"><?=$dtdefault->no_bpjs?></td>
        	</tr>	
        	<tr>
        		<td valign="top" style="color:#00008B">Masa Jabatan</td>
        		<td valign="top">:</td>
        		<td valign="top" style="color:#9900cc"><?=$dtdefault->masa_jabatan?></td>
        	</tr>	
		</table>
      </div>
      <!-- /.tab-pane -->
