  ...
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#tab_2" data-toggle="tab"><b>Informasi Kontraprestasi</b></a></li>
    </ul>
    <div class="tab-content">
      ...
      <div class="tab-pane" id="tab_2">
        <table class="table table-bordered table-striped" style="width: 100%">
			<!--<tr>-->
   <!--     		<td valign="top" style="color:#00008B" width="200px">Tanggal Awal Pembinaan</td>-->
   <!--     		<td valign="top">:</td>-->
   <!--     		<td valign="top" style="color:#9900cc"><?=tgl_indo($dtdefault->tgl_awal)?></td>-->
   <!--     	</tr>	-->
   <!--     	<tr>-->
   <!--     		<td valign="top" style="color:#00008B">Tanggal Awal Pembinaan</td>-->
   <!--     		<td valign="top">:</td>-->
   <!--     		<td valign="top" style="color:#9900cc"><?=tgl_indo($dtdefault->tgl_akhir)?></td>-->
   <!--     	</tr>	-->
   <!--     	<tr>-->
   <!--     		<td valign="top" style="color:#00008B">Nama Pembina</td>-->
   <!--     		<td valign="top">:</td>-->
   <!--     		<td valign="top" style="color:#9900cc"><?=$dtdefault->nama_pembina?></td>-->
   <!--     	</tr>	-->
   <!--     	<tr>-->
