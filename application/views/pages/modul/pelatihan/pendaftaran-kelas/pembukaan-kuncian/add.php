...
<section class="content">
  ...
  <div class="box box-danger">
    ...
    ?>
      <form action="<?=base_url('pendaftaran-kelas/pembukaan-kuncian/save-buka-kuncian/'.$dtdefault->Id_Peserta)?>" method="POST">
      ...
      <?php if(accessperm('membuka-form-data-kuncian-entry-pejabat-1')){ ?>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-6">
              <?php
              $pejabat1 = ($cekfind->num_rows()>0)? $this->session->userdata("username") : $this->session->userdata("username");
              ?>
      ...
      <?php if(accessperm('membuka-form-data-kuncian-entry-pejabat-2')){ ?>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-6">
              <?php
              $pejabat2 = ($cekfind->num_rows()>0)? $this->session->userdata("username") : $this->session->userdata("username");
              ?>
