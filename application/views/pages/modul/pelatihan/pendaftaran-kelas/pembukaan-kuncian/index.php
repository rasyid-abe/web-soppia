...
<section class="content-header">
  <h1>
    Pembukaan Kuncian Pendaftaran ke Kelas QIA
...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Manage Pembukaan Kuncian Pendaftaran ke Kelas QIA</h3>
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            ...
            <th>Foto</th>
            <th>NIPP</th>
            <th style="200px">Perusahaan/Instansi</th>
            <th style="200px">Nama Peserta</th>
            <th>Status</th>
            <th style="160px">Action</th>
          </tr>
        </thead>
        <tbody>
        </tbody>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-calon-peserta')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
    ...
    $(document).on("click",".btn-buka-kunci-entry",function(){
      var href = $(this).attr("link-href");
      $("#modal-default").find(".modal-dialog .modal-content .modal-header .modal-title").html("Verifikasi Akun anda!");
