  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pencatatan-eskt')){ ?>
        ...
        <?php }?>
         <?php if(accessperm('mengimport-data-pencatatan-eskt')){ ?>        
...
<div class="table-responsive">
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            <th>No</th>
            <th style="width:250px">Saran</th>
            <th style="width:250px">Komplain</th>
            <th>Tanggal</th>
            <th>Action</th>
          </tr>
        </thead>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pencatatan-eskt')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
