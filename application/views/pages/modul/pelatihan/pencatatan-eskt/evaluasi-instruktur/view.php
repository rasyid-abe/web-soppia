<table class="table table-bordered table-striped" style="width: 100%">
	<tr>
		...
		<td valign="top">:</td>
		<td valign="top"><?=getnamainstruktur($dtdefault->FId_InstrukturNgajar_diKelas)?></td>
	</tr>
	<tr>
		<td valign="top">Nama Peserta</td>
		<td valign="top">:</td>
		<td valign="top"><?=getnamapeserta($dtdefault->FId_Peserta)?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td valign="top"><?=getjwbeval($dtdefault->Jwb_Eval4)?></td>
	</tr>
	<tr>
		<td valign="top">Jawaban Eval 5</td>
		<td valign="top">:</td>
		<td valign="top"><?=getjwbeval($dtdefault->Jwb_Eval5)?></td>
	</tr>
	<tr>
		<td valign="top">Jawaban Eval 6</td>
		<td valign="top">:</td>
		<td valign="top"><?=getjwbeval($dtdefault->Jwb_Eval6)?></td>
	</tr>
	<tr>
		<td valign="top">Jawaban Eval 7</td>
		<td valign="top">:</td>
		<td valign="top"><?=getjwbeval($dtdefault->Jwb_Eval7)?></td>
	</tr>	
	<tr>
		<td valign="top">Jawaban Eval 8</td>
		<td valign="top">:</td>
		<td valign="top"><?=getjwbeval($dtdefault->Jwb_Eval8)?></td>
	</tr>	
	<tr>
		<td valign="top">Jawaban Eval 9</td>
		<td valign="top">:</td>
		<td valign="top"><?=getjwbeval($dtdefault->Jwb_Eval9)?></td>
	</tr>	
	<tr>
		<td valign="top">Saran Eval</td>
		<td valign="top">:</td>
		<td valign="top"><?=$dtdefault->Saran_Eval;?></td>
	</tr>
</table>