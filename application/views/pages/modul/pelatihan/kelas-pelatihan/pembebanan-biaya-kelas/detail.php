    ...
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pembebanan-biaya-kelas')){ ?>
          <a href="<?=base_url("kelas-pelatihan/pembebanan-biaya-kelas/add/".$data->Id_Kelas_n_Angkatan)?>" class="btn btn-box-tool" data-toggle="tooltip" title="Pengeluaran Biaya Kelas IHT"> <i class="fa fa-plus-circle"></i> Biaya</a>
        <?php }else{?>
          <a class="btn btn-box-tool" data-toggle="tooltip" title="No Access"><i class="fa fa-plus-circle"></i> No Access</a>
        <?php }?>
        <?php if(accessperm('menambahkan-data-pembebanan-biaya-kelas')){ ?>
          <a href="<?=base_url("kelas-pelatihan/pembebanan-biaya-kelas/pendapatan/".$data->Id_Kelas_n_Angkatan)?>" class="btn btn-box-tool" data-toggle="tooltip" title="Pemasukan Pendapatan Kelas IHT"> <i class="fa fa-plus-circle"></i> Pendapatan</a>
        <?php }else{?>
          <a class="btn btn-box-tool" data-toggle="tooltip" title="No Access"><i class="fa fa-plus-circle"></i> No Access</a>
        <?php }?>
        <a href="<?=base_url($this->uri->segment(1).'/pembebanan-biaya-kelas')?>" class="btn btn-box-tool" data-toggle="tooltip" title="Kembali Ke Manage Laporan Kelas"> <i class="fa fa-arrow-circle-left"></i> Back</a>
