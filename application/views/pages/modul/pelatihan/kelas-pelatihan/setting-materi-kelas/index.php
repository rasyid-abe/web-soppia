  ...
  <div class="box" style="border-top:0px solid">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-setting-materi-kelas')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-setting-materi-kelas')){ ?>        
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            ...
            <th width="300px">Dokumen Kelas</th>
          </tr>
        </thead>
        <tbody>
        </tbody>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-setting-materi-kelas')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
