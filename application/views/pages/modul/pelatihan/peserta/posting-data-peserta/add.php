...
<section class="content">
  ...
  <div class="row">
        ...
        <div class="box-body">
          ...
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              NIPP<br/>
              <input type="number" min="0" class="form-control" name="nipp" id="nipp" placeholder="Nomer Induk Peserta Pelatihan" value="<?=$this->session->flashdata('oldinput')['nipp']?>"  required="required"  >
            </div>
          </div>
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              NIK<br/>
              <input type="number" min="0" class="form-control" name="nik" id="nik" placeholder="Nomer Induk Kependudukan" value="<?=$this->session->flashdata('oldinput')['nik']?>"  required="required" >
            </div>
          </div>
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              Nama Lengkap (tanpa gelar)<br/>
              <input type="text" class="form-control" name="nl_no_g" id="nl_no_g" placeholder="Nama lengkap (tanpa gelar)" value="<?=$this->session->flashdata('oldinput')['nl_no_g']?>" >
            </div>
          </div>
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
          ...
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              Kota Lahir<br/>
              <input type="text" class="form-control" name="kotalahir" id="kotalahir" placeholder="Kota Lahir" value="<?=$this->session->flashdata('oldinput')['kotalahir']?>" >
            </div>
          </div>     
          ...
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              Tanggal Lahir<br/>
              <input type="text" class="form-control date" name="tgllahir" id="tgllahir" placeholder="Tanggal Lahir" value="<?=$this->session->flashdata('oldinput')['tgllahir']?>"  required="required"  >
            </div>    
          </div>
    ...
    <div class="col-sm-6"> 
      <div class="box" style="border-top:0px solid">
        <div class="box-header with-border">
          <h3 class="box-title">Sudah QIA ?</h3>
        </div>
        <div class="box-body">
          ...
          <div class="form-group col-sm-12"> 
            <div class="col-sm-12" style="color:#00008B">
              Sudah QIA ?<br/>    
              <select name="sudahqia" class="form-control select2" id="sudahqia" style="width: 100%;">
                <option value="" readonly selected>Pilih</option>
                <?php
                   $slc1 = ($this->session->flashdata('oldinput')['sudahqia']=="Y")? 'selected':'';
                   $slc2 = ($this->session->flashdata('oldinput')['sudahqia'] =="N")? 'selected':'';
                ?>
                <option value="Y" <?=$slc1?> >Sudah QIA</option>
                <option value="N" <?=$slc2?> >Belum QIA</option>
              </select>
            </div>  
          </div>
          ...
          <div class="qia">
            <div class="form-group col-sm-12"> 
               <div class="col-sm-6" style="color:#00008B">
                Sudah Wisuda QIA ?<br/>    
                <select name="sudahwisudaqia" class="form-control select2" id="sudahwisudaqia" style="width: 100%;">
                  <option value="" readonly selected>Pilih</option>
                  <?php
                     $slc1 = ($this->session->flashdata('oldinput')['sudahwisudaqia']=="Y")? 'selected':'';
                     $slc2 = ($this->session->flashdata('oldinput')['sudahwisudaqia'] =="N")? 'selected':'';
                  ?>
                  <option value="Y" <?=$slc1?> >Sudah Wisuda</option>
                  <option value="N" <?=$slc2?> >Belum Wisuda</option>
                </select>
              </div>  
            </div>
            ...
            <div class="form-group col-sm-12"> 
               <div class="col-sm-12" style="color:#00008B">
                Tanggal Wisuda QIA<br/>
                <input type="text" class="form-control date" name="tglwisudaqia" id="tglwisudaqia" placeholder="Tanggal Wisuda QIA">
              </div>
            </div>
          </div>
