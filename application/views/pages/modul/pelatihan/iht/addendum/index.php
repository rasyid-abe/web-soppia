  ...
  <div class="box" style="border-top:0px solid">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-addendum')){ ?>
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            <th>No</th>
            <th>No Urut</th>
            <th>Addendum Kontrak</th>
            <th>Proforma Kesepakatan Pelatihan</th>
            <th>Perusahaan/Instansi</th>
            <th>Nilai Rp</th>
            <th>Jumlah Peserta</th>
            <th>Rencana Tempat Penyelenggaraan</th>
            <th>File_Lampiran</th>
            <th>Action</th>
          </tr>
        </thead>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-addendum')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
