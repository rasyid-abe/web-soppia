      ...
      <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/store")?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-6" style="color:#00008B">
            ...
            <input type="text" class="form-control" name="Desc_DokBukaKlsReguler" id="Desc_DokBukaKlsReguler" placeholder="Desc Dok Pembukaan Kelas Non IHT" value="<?=$this->session->flashdata('oldinput')['Desc_DokBukaKlsReguler']?>" >
          </div>
        </div>
