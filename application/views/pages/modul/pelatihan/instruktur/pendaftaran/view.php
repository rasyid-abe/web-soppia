<table class="table table-bordered table-striped" style="width: 100%">
	...
	<tr>
		...
		<td valign="top">:</td>
		<td valign="top"><?=getpersinstansi($dtdefault->FId_PershInstansi)?></td>
	</tr>
	<tr>
		<td valign="top" style="color:#00008B">NIIS</td>
		<td valign="top">:</td>
		<td valign="top" style="color:#9900cc"><?=$dtdefault->NIIS?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<?php
		    $panggil = "--";
		    if($dtdefault->NamaPanggilan != null){
		        $panggil = $dtdefault->NamaPanggilan;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$panggil?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<?php
		    $alamat = "--";
		    if($dtdefault->Alamat_Rumah != null){
		        $alamat = $dtdefault->Alamat_Rumah;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$alamat?></td>
	</tr>
	<tr>
		...
		<?php
		    $telpon = "--";
		    if($dtdefault->Telp_Rumah != null){
		        $telpon = $dtdefault->Telp_Rumah;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$telpon?></td>
	</tr>
	<tr>
		...
		<?php
		    $hpp = "--";
		    if($dtdefault->No_HP != null){
		        $hpp = $dtdefault->No_HP;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$hpp?></td>
	</tr>
	<tr>
		...
		<?php
		    $emp = "--";
		    if($dtdefault->eMail_Pribadi != null){
		        $emp = $dtdefault->eMail_Pribadi;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$emp?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td valign="top"><?=getbidangpendidikan($dtdefault->FKd_BidangPendidikan1)?></td>
	</tr>
	<?php
		...
		<tr>
			...
			<td valign="top">:</td>
			<td valign="top"><?=getbidangpendidikan($dtdefault->FKd_BidangPendidikan2)?></td>
		</tr>
	<?php } ?>
	<?php
	...
	<tr>
		...
		<?php
		    $jbtn = "--";
		    if($dtdefault->Jabatan_NamaUnitOrganisasi != null){
		        $jbtn = $dtdefault->Jabatan_NamaUnitOrganisasi;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$jbtn?></td>
	</tr>
	<tr>
		...
		<?php
		    $akant = "--";
		    if($dtdefault->Alamat_Kantor != null){
		        $akant = $dtdefault->Alamat_Kantor;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$akant?></td>
	</tr>
	<tr>
		...
		<?php
		    $telpkan = "--";
		    if($dtdefault->Telp_Kantor != null){
		        $telpkan = $dtdefault->Telp_Kantor;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$telpkan?></td>
	</tr>
	<tr>
		...
		<?php
		    $emkant = "--";
		    if($dtdefault->eMail_Kantor != null){
		        $emkant = $dtdefault->eMail_Kantor;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$emkant?></td>
	</tr>
	<tr>
		...
		<?php
		    ...
		    if($dtdefault->Keterangan != null){
		        $kett = $dtdefault->Keterangan;
		    }
		?>
		<td valign="top" style="color:#9900cc"><?=$kett?></td>
	</tr>
	<?php
		if($dtdefault->Flag_Deleted == "Y"){
	?>
	<tr>
		<td valign="top" style="color:#00008B">Alasan Dihapus</td>
		<td valign="top">:</td>
		<td valign="top" style="color:#9900cc"><?=$dtdefault->Reason_to_Delete;?></td>
	</tr>
	<tr>
		<td valign="top" style="color:#00008B">Dihapus Oleh</td>
		<td valign="top">:</td>
		<td valign="top" style="color:#9900cc"><?=$dtdefault->Delete_By;?></td>
	</tr>
	<tr>
		<td valign="top" style="color:#00008B">Dihapus Tanggal</td>
		<td valign="top">:</td>
		<td valign="top" style="color:#9900cc"><?=tgl_indo($dtdefault->Delete_Date);?></td>
	</tr>
	<?php
		}
	?>
