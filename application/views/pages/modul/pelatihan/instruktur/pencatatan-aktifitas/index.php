  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pencatatan-aktifitas')){ ?>
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            ...
            <th style="width:200px">Deskripsi Kegiatan</th>
            <th>Tanggal</th>
            <th>Jam Mulai</th>
            <th>Jam Berakhir</th>
            <th>Action</th>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pencatatan-aktifitas')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
