          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Isi_PertanyaanSoal" id="Isi_PertanyaanSoal" placeholder="Isi Pertanyaan" required><?=$this->session->flashdata('oldinput')['Isi_PertanyaanSoal']?></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-12">
                    <div class="col-sm-4">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Jawab_yg_Benar" id="Jawab_yg_Benar" placeholder="Jawaban Yang Benar" required><?=$this->session->flashdata('oldinput')['Jawab_yg_Benar']?></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-12">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Penjelasan_Jawaban" id="Penjelasan_Jawaban" placeholder="Penjelasan Jawaban" required><?=$this->session->flashdata('oldinput')['Penjelasan_Jawaban']?></textarea>
                    </div>
                </div>
            </div> <!--row-6-->
            ...
            <div class="form-group col-sm-6">
                <div class="form-group col-sm-12">
                    <div class="col-sm-4">
                      <label>File Lampiran (Jika Diperlukan)</label>
                    </div>
                    <div class="col-sm-1">
                      <label>:</label>
                    </div>
                ...
                <div class="form-group col-sm-12 point-a">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Jawab_Point_a" id="Jawab_Point_a" placeholder="Jawaban Point A"><?=$this->session->flashdata('oldinput')['Jawab_Point_a']?></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-12 point-b">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Jawab_Point_b" id="Jawab_Point_b" placeholder="Jawaban Point B"><?=$this->session->flashdata('oldinput')['Jawab_Point_b']?></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-12 point-c">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Jawab_Point_c" id="Jawab_Point_c" placeholder="Jawaban Point C"><?=$this->session->flashdata('oldinput')['Jawab_Point_c']?></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-12 point-d">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Jawab_Point_d" id="Jawab_Point_d" placeholder="Jawaban Point D"><?=$this->session->flashdata('oldinput')['Jawab_Point_d']?></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-12 point-e">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="Jawab_Point_e" id="Jawab_Point_e" placeholder="Jawaban Point E"><?=$this->session->flashdata('oldinput')['Jawab_Point_e']?></textarea>
                    </div>
                </div>
            </div> <!--row-6--> <br/><br/>
