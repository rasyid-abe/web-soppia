  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-set-rencana-ujian-cbt')){ ?>
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            ...
            <th style="width:50px">ID Kelas</th>
            <th style="width:200px">Jenis Pelatihan</th>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-set-rencana-ujian-cbt')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
