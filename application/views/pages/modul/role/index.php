  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-role')){ ?>
        ...
        <?php }?>
        <!-- <?php if(accessperm('mengimport-data-role')){ ?>        
...
<div class="table-responsive">
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            <th>No</th>
            <th style="width:150px">Nama Role/Peran</th>
            <th style="width:230px">Keterangan</th>
            <th style="width:150px">Setting Menu</th>
            <th>Set Time Access</th>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "order": [], 
      <?php if(accessperm('mengekspor-data-role')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
