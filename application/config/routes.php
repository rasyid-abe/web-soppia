...
/* start data reception-security */
	// $route['reception-security/reception'] = 'reception-security/reception/index';
	// $route['reception-security/reception/getdata'] = 'reception-security/reception/getdata';
	// $route['reception-security/reception/add'] = 'reception-security/reception/add';
	// $route['reception-security/reception/store'] = 'reception-security/reception/store';
	// $route['reception-security/reception/edit/(:any)'] = 'reception-security/reception/edit/$1';
	// $route['reception-security/reception/update/(:any)'] = 'reception-security/reception/update/$1';
	// $route['reception-security/reception/delete/(:any)'] = 'reception-security/reception/delete/$1';
	// $route['reception-security/reception/delete-exec/(:any)'] = 'reception-security/reception/delete_exec/$1';
	// $route['reception-security/reception/view/(:any)'] = 'reception-security/reception/view/$1';
/* end data reception-security */


/* start data data-jadwal */
	// $route['jadwal-kerja/data_jadwal'] = 'jadwal-kerja/data_jadwal/index';
	// $route['jadwal-kerja/data_jadwal/getdata'] = 'jadwal-kerja/data_jadwal/getdata';
	// $route['jadwal-kerja/data_jadwal/add'] = 'jadwal-kerja/data_jadwal/add';
	// $route['jadwal-kerja/data_jadwal/store'] = 'jadwal-kerja/data_jadwal/store';
	// $route['jadwal-kerja/data_jadwal/edit/(:any)'] = 'jadwal-kerja/data_jadwal/edit/$1';
	// $route['jadwal-kerja/data_jadwal/update/(:any)'] = 'jadwal-kerja/data_jadwal/update/$1';
	// $route['jadwal-kerja/data_jadwal/delete/(:any)'] = 'jadwal-kerja/data_jadwal/delete/$1';
	// $route['jadwal-kerja/data_jadwal/delete-exec/(:any)'] = 'jadwal-kerja/data_jadwal/delete_exec/$1';
	// $route['jadwal-kerja/data_jadwal/view/(:any)'] = 'jadwal-kerja/data_jadwal/view/$1';
/* end data data-jadwal */
