...
class Informasi_skt extends CI_Controller {
 	protected  $name = 'Informasi skt'; 
    protected  $model = 'Rinformasiskt_model';
 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'Riset & Pengembangan'; 
 	protected  $breadcrumb3 = 'Informasi SKT'; 
	...
	public function index(){
		permissions('melihat-data-informasi-skt');
		$urlnow = uri_string();
		$data = array(
	...
	public function getdata(){
        ...
        foreach ($list as $field) {
            ...
            if($field->Isi_TL_yg_sudah_dilakukan==null) {
                $tl = "-";
            } else $tl = $field->Isi_TL_yg_sudah_dilakukan;
	...
	public function actiontable($id){
		if(accessperm('melihat-data-informasi-skt')){
		...
		if(accessperm('merubah-data-informasi-skt')){
		...
		if(accessperm('menghapus-data-informasi-skt')){
	...
	public function edit($id){
		permissions('merubah-data-informasi-skt');
	...
	public function delete($id){
		permissions('menghapus-data-informasi-skt');
