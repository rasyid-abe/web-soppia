...
class Perusahaan extends CI_Controller {
 	protected  $name = 'Perusahaan'; 
    protected  $model = 'data/perusahaan-instansi/Rperusahaan_model'; 

 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'Perusahaan'; 
	...
	public function index(){
		...
		recordlog("Mengakses Halaman Data Perusahaan");
	...
	public function actiontable($id){
		...
		if(accessperm('merubah-data-perusahaan')){
			$btn .= "<a href='".base_url('perusahaan-instansi/'.url_title(strtolower($this->name))."/edit/".$id)."' class='btn btn-xs btn-warning' data-toggle='tooltip' title='Edit Data'> <i class='fa fa-pencil-square'></i> Edit </a> ";
        }else{
