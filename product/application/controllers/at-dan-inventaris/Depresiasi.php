...
class Depresiasi extends CI_Controller {
 	protected  $name = 'Depresiasi'; 
    protected  $model = 'umum/at-dan-inventaris/Rdepresiasi_model';
 	protected  $breadcrumb1 = 'Dashboard'; 
 	protected  $breadcrumb2 = 'At Dan Inventaris'; 
 	protected  $breadcrumb3 = 'Depresiasi'; 
	...
	public function index(){
		permissions('melihat-data-depresiasi');
		$urlnow = uri_string();
		$data = array(
	...
	public function actiontable($id){
		if(accessperm('melihat-data-depresiasi')){
		...
		if(accessperm('merubah-data-depresiasi')){
		...
		if(accessperm('menghapus-data-depresiasi')){
	...
	public function add(){
		permissions('menambahkan-data-depresiasi');
	...
	public function edit($id){
		permissions('merubah-data-depresiasi');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-depresiasi');
