...
class Bidang_pendidikan extends CI_Controller {
 	protected  $name = 'Bidang pendidikan'; 
    protected  $model = 'referensi/data-diri/Rbidangpendidikan_model'; 
	...
	public function index(){
		permissions('melihat-data-bidang-pendidikan');
		$urlnow = uri_string();
		$data = array(
	...
	public function getdata(){
        ...
        foreach ($list as $field) {
            ...
            $row = array();
            $row[] = $no;
            $row[] = $field->Desc_BidangPendidikan;
            $row[] = $this->actiontable($field->Kd_BidangPendidikan);
	...
	public function actiontable($id){
		if(accessperm('melihat-data-bidang-pendidikan')){
		...
		if(accessperm('merubah-data-bidang-pendidikan')){
		...
		if(accessperm('menghapus-data-bidang-pendidikan')){
	...
	public function add(){
		permissions('menambahkan-data-bidang-pendidikan');
	...
	public function store(){	
		...
		$this->form_validation->set_rules('name', 'Name', 'trim|required|is_unique[ref_bidangpendidikan.Desc_BidangPendidikan]|xss_clean');
	...
	public function edit($id){
		permissions('merubah-data-bidang-pendidikan');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-bidang-pendidikan');
