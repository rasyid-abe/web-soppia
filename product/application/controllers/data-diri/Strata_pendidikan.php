...
class Strata_pendidikan extends CI_Controller {
 	protected  $name = 'Strata pendidikan'; 
    protected  $model = 'referensi/data-diri/Rstratapendidikan_model'; 
	...
	public function index(){
		permissions('melihat-data-strata-pendidikan');
		$urlnow = uri_string();
		$data = array(
	...
	public function getdata(){
        ...
        foreach ($list as $field) {
            ...
            $row = array();
            $row[] = $no;
            $row[] = $field->Desc_StrataPendidikan;
            $row[] = $this->actiontable($field->Kd_StrataPendidikan);
	...
	public function actiontable($id){
		if(accessperm('melihat-data-strata-pendidikan')){
		...
		if(accessperm('merubah-data-strata-pendidikan')){
		...
		if(accessperm('menghapus-data-strata-pendidikan')){
	...
	public function add(){
		permissions('menambahkan-data-strata-pendidikan');
	...
	public function store(){	
		...
		$this->form_validation->set_rules('name', 'Name', 'trim|required|is_unique[ref_stratapendidikan.Desc_StrataPendidikan]|xss_clean');
	...
	public function edit($id){
		permissions('merubah-data-strata-pendidikan');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
	...
	public function delete($id){
		permissions('menghapus-data-strata-pendidikan');
