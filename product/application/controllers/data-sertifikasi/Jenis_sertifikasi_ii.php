...
class Jenis_sertifikasi_ii extends CI_Controller {
 	protected  $name = 'Jenis sertifikasi ii'; 
    protected  $model = 'referensi/data-sertifikasi/Rjenissertifikasi2_model'; 
	...
	public function index(){
		permissions('melihat-data-jenis-sertifikasi-ii');
		$urlnow = uri_string();
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
			'breadcrumb3'=>'Jenis Sertifikasi II',
			'titlepage'=>'Jenis Sertifikasi II',
			'subtitlepage'=>'Data Jenis Sertifikasi II',
			'titlebox'=>'Manage Jenis Sertifikasi II',
	...
	public function getdata(){
        ...
        foreach ($list as $field) {
            ...
            $row = array();
            $row[] = $no;
            $row[] = $field->Desc_Jns_Sertifikasi2;
            $row[] = $this->actiontable($field->Kd_Jns_Sertifikasi2);
	...
	public function actiontable($id){
		if(accessperm('melihat-data-jenis-sertifikasi-ii')){
		...
		if(accessperm('merubah-data-jenis-sertifikasi-ii')){
		...
		if(accessperm('menghapus-data-jenis-sertifikasi-ii')){
	...
	public function add(){
		permissions('menambahkan-data-jenis-sertifikasi-ii');
		...
		$data = array(
			...
			'titlepage'=>'Jenis Sertifikasi II',
			'subtitlepage'=>'Data Jenis Sertifikasi II',
			'titlebox'=>'Add Jenis Sertifikasi II',
			'urlback'=>$this->db->where("url",$urlnow)->get("menu")
		);
	...
	public function store(){	
		...
		$description = $this->security->xss_clean(html_escape($this->input->post("Desc_Jns_Sertifikasi2")));

		$this->form_validation->set_rules('Desc_Jns_Sertifikasi2', 'Description', 'trim|required|is_unique[ref_jenis_sertifikasi2.Desc_Jns_Sertifikasi2]|xss_clean');
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data = array(
				'Desc_Jns_Sertifikasi2'=>$description,
			);
	...
	public function edit($id){
		permissions('merubah-data-jenis-sertifikasi-ii');
		$urlnow = $this->uri->segment(1).'/'.$this->uri->segment(2);
		$data = array(
			'breadcrumb1'=>$this->breadcrumb1,
			'breadcrumb2'=>$this->breadcrumb2,
			...
			'titlepage'=>'Jenis Sertifikasi II',
			'subtitlepage'=>'Data Jenis Sertifikasi II',
			'titlebox'=>'Edit Jenis Sertifikasi II',
	...
	public function update($id){	
		...
		$this->form_validation->set_rules('Desc_Jns_Sertifikasi2', 'Description', 'trim|required|xss_clean');
	...
	public function delete($id){
		permissions('menghapus-data-jenis-sertifikasi-ii');
