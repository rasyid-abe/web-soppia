                  ...
                  <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$noomas?>"><?=$mn->name?></a>
                      <label class="pull-right">
                        ...
                        <input type="checkbox" class="flat-red set-menu-checkbox" data-role="<?=$role->idrole?>" data-perm="<?=$mn->idmenu?>"  <?=$check?> >
                      </label>
                  </h4>
                </div>
                          ...
                          <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion<?=$noomas?>" href="#collapseaa<?=$noomas?><?=$noomasa?>"><?=$cekank->name?></a>
                              <label class="pull-right">
                                ...
                                <input type="checkbox" class="flat-red set-menu-checkbox" data-role="<?=$role->idrole?>" data-perm="<?=$cekank->idmenu?>"  <?=$check?> >
                              </label>
                          </h4>
                        </div>
                                    ...
                                    <h4 class="panel-title">
                                      <a data-toggle="collapse" data-parent="#accordion<?=$noomasa?>" href="#collapseaa<?=$noomas?><?=$noomasa?><?=$nomasaabb?>"><?=$kv->name?></a>
                                        ...
                                        <label class="pull-right">
                                          ...
                                          <input type="checkbox" class="flat-red set-menu-checkbox" data-role="<?=$role->idrole?>" data-perm="<?=$kv->idmenu?>"  <?=$check?> >
                                        </label>
                                    </h4>
                                  </div>
