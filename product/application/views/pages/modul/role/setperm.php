        ...
        <div class="panel-group" id="accordion">
          ...
          ?>
              <div class="panel panel-default">
                ...
                <?php    
                  $getpermabc = $this->db->where('idmenu',$mn->idmenu)->order_by("name")->get("permission");
                  if($getpermabc->num_rows()>0){
                    foreach ($getpermabc->result() as $val) {
                      ?>
                ...
                ?>
                 <?php
                  $cekanak = $this->db->where( array('parent'=>$mn->idmenu,'active'=>'1') )->order_by("urutan")->get("menu");
                    ...
                    ?>
                      <div class="panel panel-default">
                        ...
                        <div id="collapseaa<?=$noomas?><?=$noomasa?>" class="panel-collapse collapse ">
                          <?php
                            $ceksubdarianak = $this->db->where(array('parent'=>$cekank->idmenu,'active'=>'1'))->order_by("urutan")->get("menu");
