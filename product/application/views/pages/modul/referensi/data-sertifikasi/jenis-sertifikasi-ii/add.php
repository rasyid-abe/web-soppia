      ...
      <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/store")?>" method="POST">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-12">
            ...
            <input type="text" class="form-control" name="Desc_Jns_Sertifikasi2" id="Desc_Jns_Sertifikasi2" placeholder="Desc Jenis Sertifikasi II"  value="<?=$this->session->flashdata('oldinput')['name']?>" >
          </div>
        </div>
