    ...
    <div class="box-body">
      <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/store")?>" method="POST">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-12">
            Nama Gedung <br>
            <input type="text" class="form-control" name="name" id="name" placeholder="Name Gedung"  value="<?=$this->session->flashdata('oldinput')['name']?>" >
          </div>
        </div>
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-12">
            Alamat Gedung <br>
            <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat"  value="<?=$this->session->flashdata('oldinput')['alamat']?>" >
          </div>
        </div>
