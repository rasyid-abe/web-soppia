  ...
  <div class="box" style="border-top:0px solid">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-detail-paket-sesi-harian')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-detail-paket-sesi-harian')){ ?>        
        ...
        <?php }?>
        <!-- <a  class="btn btn-box-tool" data-toggle="tooltip" title="Kembali"><i class="fa fa-arrow-circle-left"></i> Back</a> -->
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-detail-paket-sesi-harian')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
