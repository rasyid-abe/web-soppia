...
<section class="content">
  ...
  <div class="box" style="border-top:0px solid">
    ...
    <div class="box-body">
      <form action="<?=base_url("data-sesi/paket-sesi-harian/pengaturansesipaketstore/".$idpaket)?>" method="POST">
          ...
          <div class="col-sm-6">
            ...
            <select name="FKd_Sesi_Satuan" class="form-control select2" style="width: 100%;">
              ...
              foreach ($fkd_sesi_satuan->result() as $fkd2) {
                $slc = ($this->session->flashdata('oldinput')['FKd_Sesi_Satuan']==$fkd2->Kd_Sesi_Satuan)? 'selected':'';
              ?>
