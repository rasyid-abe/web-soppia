      ...
      <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/store")?>" method="POST">
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-6">
            ...
            <input type="text" class="form-control" name="Desc_Sesi" id="Desc_Sesi" placeholder="Desc Sesi Satuan"  value="<?=$this->session->flashdata('oldinput')['Desc_Sesi']?>" >
          </div>
        </div>
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-6">
            ...
            <select name="Flag_Ramadhan" class="form-control select2" style="width: 100%;">
              ...
              <?php
                $slc1 = ($this->session->flashdata('oldinput')['Flag_Ramadhan'] == "Y" )? 'selected' :'';
                $slc2 = ($this->session->flashdata('oldinput')['Flag_Ramadhan'] == "N" )? 'selected' :'';
              ?>
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-6">
            ...
            <select name="Flag_Jumat" class="form-control select2" style="width: 100%;">
              ...
              <?php
                $slc3 = ($this->session->flashdata('oldinput')['Flag_Jumat'] == "Y" )? 'selected' :'';
                $slc4 = ($this->session->flashdata('oldinput')['Flag_Jumat'] == "N" )? 'selected' :'';
              ?>
        ...
        <div class="form-group col-sm-12">
          <div class="col-sm-6">
            ...
            <select name="Flag_RehatLunch" class="form-control select2" style="width: 100%;">
              ...
              <?php
                $slc5 = ($this->session->flashdata('oldinput')['Flag_RehatLunch'] == "Y" )? 'selected' :'';
                $slc6 = ($this->session->flashdata('oldinput')['Flag_RehatLunch'] == "N" )? 'selected' :'';
              ?>
