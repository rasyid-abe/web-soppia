      ...
      <div class="col-md-12"> 
        <div class="box box-warning">
          <div class="box-header with-border">
            ...
            <div class="box-body">
              <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/update/".$dtdefault->id_lembur)?>" method="POST">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="tgl_lembur" placeholder="Tanggal Lembur" value="<?=$dtdefault->tgl_lembur?>" >
                  </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="time" class="form-control" name="jam_awal" placeholder="Jam Awal" value="<?=$dtdefault->jam_awal?>" >
                  </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="time" class="form-control" name="jam_akhir" placeholder="Jam Akhir" value="<?=$dtdefault->jam_akhir?>" >
                  </div>
                </div>
