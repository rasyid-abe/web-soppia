  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pembinaan-pegawai')){ ?>
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            ...
            <th>ID Pegawai</th>
            <th>Nama Pegawai</th>
            <th>Tanggal Awal Pembinaan</th>
            <th>Tanggal Akhir Pembinaan</th>
            <th>Nama Pembina</th>
            <th>Action</th>
          </tr>
        </thead>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pembinaan-pegawai')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
