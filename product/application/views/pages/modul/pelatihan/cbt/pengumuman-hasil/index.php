  ...
  <div class="box" style="border-top:0px solid">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pengumuman-hasil-cbt')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-pengumuman-hasil-cbt')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pengumuman-hasil-cbt')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
