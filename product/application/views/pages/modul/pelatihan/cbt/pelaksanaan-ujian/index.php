  ...
  <div class="box" style="border-top:0px solid">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pelaksanaan-ujian')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-pelaksanaan-ujian')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pelaksanaan-ujian')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
