  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-calon-peserta')){ ?>
        ...
        <?php }?><!-- 
        <?php if(accessperm('mengimport-data-calon-peserta')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $(document).on("click",".posting-data-posting",function(e){
      e.preventDefault();
      var _link = $(this).attr("data-href");
        $("#modal-default").find(".modal-dialog .modal-content .modal-header .modal-title").html("Konfirmasi Posting Data");
        $("#modal-default").find(".modal-dialog .modal-content .modal-body").html("Anda yakin data detail calon peserta sudah lengkap dan ingin memposting data ini?<br/><br/><button data-href='"+_link+"' id='posting-data-posting-lagi' class='btn btn-primary btn-sm'> Posting </button> <button class='btn btn-danger btn-sm' data-dismiss='modal'>Batal</button>");
        $("#modal-default").find(".modal-dialog").addClass("animated bounceIn");
        $("#modal-default").modal("show");
    });
    $(document).on("click","#posting-data-posting-lagi",function(){
      //e.preventDefault();
      var _link = $(this).attr("data-href");
      $.ajax({url: _link, success: function(result){
          //alert(result);
