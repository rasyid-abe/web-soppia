  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pembukaan-kelas-non-iht')){ ?>
...
<div class="table-responsive">
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            <th>No</th>
            <th width="180px">SK Pembukaan Kelas Reguler</th>
            <th>Nomor SK Pembukaan Kelas Reguler</th>
            <th style="width:180px">Rencana Tempat Penyelenggaraan</th>
            <th>File Lampiran</th>
            <th>Action</th>
          </tr>
        </thead>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pembukaan-kelas-non-iht')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
