...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?=base_url('submenu/index/'.$urlback->row()->parent)?>"><?=$breadcrumb2?></a></li>
  ...
  <div class="box" style="border-top:0px solid">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-restore')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-restore')){ ?>        
        ...
        <?php }?>
        <a href="<?=base_url('submenu/index/'.$urlback->row()->parent)?>" class="btn btn-box-tool" data-toggle="tooltip" title="Kembali"><i class="fa fa-arrow-circle-left"></i> Back</a>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-restore')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
        { extend: 'copy', text: '<i class="fa fa-copy"></i> Copy'},
        { extend: 'excel', text: '<i class="fa fa-save"></i> Excel',title:'<?=$subtitlepage?>' },
        { extend: 'csv', text: '<i class="fa fa-save"></i> Csv',title:'<?=$subtitlepage?>' },
        { extend: 'pdf', text: '<i class="fa fa-save"></i> Pdf' ,title:'<?=$subtitlepage?>'},
        { extend: 'print', text: '<i class="fa fa-print"></i> Print',title:'<?=$subtitlepage?>' },
      ],
      <?php } ?>
      "ajax": {
