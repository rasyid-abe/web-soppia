...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Pilih Materi Pelatihan</h3></h3>
...
<div class="table-responsive">
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            <th>No</th>
            <th style="140px">Nama Instruktur</th>
            <th style="140px">Nama Materi / Aktifitas</th>
            <th>Singkatan</th>
            <th>Skor</th>
            <th>Daftar Nilai</th>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-evaluasi-instruktur')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
      ...
      <?php } ?>
      "ajax": {
        "url": "<?php echo site_url($this->uri->segment(1).'/'.$this->uri->segment(2).'/getmateri/'.$id)?>",
        "type": "POST",
