...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Manage Pengantaran / Entry Permohonan Placement</h3>

      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pengantaran-permohonan')){ ?>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pengantaran-permohonan')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
