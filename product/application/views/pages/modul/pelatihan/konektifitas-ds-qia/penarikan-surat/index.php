...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Manage Penarikan / Entry Surat Placement</h3>
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            ...
            <th style="width:160px">Nama Perusahaan</th>
            <th>Tanggal Surat Placement</th>
            <th>File Surat Placement</th>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-penarikan-surat')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
