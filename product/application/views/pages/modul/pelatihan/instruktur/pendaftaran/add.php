...
<section class="content">
  ...
  <div class="box" style="border-top:0px solid">
    <div class="box-header with-border">
      <h3 class="box-title">Add Instruktur</h3>
        ...
        <div class="box-body">
          ...
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              NIIS<br/>
              <input type="text" class="form-control" name="niis" id="niis" placeholder="Nomer Induk Peserta Pelatihan" value="<?=$this->session->flashdata('oldinput')['niis']?>"  required="required"  >
            </div>
          </div>
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              NIK<br/>
              <input type="text" class="form-control" name="nik" id="nik" placeholder="Nomer Induk Kependudukan" value="<?=$this->session->flashdata('oldinput')['nik']?>"  required="required" >
            </div>
          </div>
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
          ...
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              ...
              <input type="text" class="form-control" name="nl_w_g" id="nl_w_g" placeholder="Nama lengkap (dengan gelar)" value="<?=$this->session->flashdata('oldinput')['nl_w_g']?>"  required>
            </div>
          </div>
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
          ...
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              Jenis Kelamin<br/>
              <select name="jeniskelamin" class="form-control select2" id="jeniskelamin" style="width: 100%;" required>
        ...
        <div class="box-body">
          ...
          <div class="form-group col-sm-12">
            <div class="col-sm-12" style="color:#00008B">
              ...
              <input type="text" class="form-control" name="namaperusahaaninstansi" id="namaperusahaaninstansi" placeholder="Nama Perusahaan /Instansi" value="<?=$this->session->flashdata('oldinput')['namaperusahaaninstansi']?>" readonly >
            </div>
          </div>
...
<script type="text/javascript">  
  $(function () {
   ...
   /* $(document).on("change",'#gelar.select2',function(){
    ...
    var testd = $('#gelar');
    testd.on("select2:select",function(){
        var _thisval = $(this).val();
        _gelar.push(_thisval);
    });
    testd.on("select2:opening", function(event) {
        var _counting = _gelar.length;
        if(_counting>0){
            for(var _i = 0;_i<_counting;_i++){
                $(this).find("option[value='" + _gelar[_i] + "']").remove();
            }
        }
    });
    ...
    $(document).on("click","#add-gelar",function(){
      ...
      if(counting == 5555555555555555555555555555555555555555 ){
    ...
    var testc = $('#sertifikasi');
    testc.on("select2:select",function(){
        var _thisval = $(this).val();
        _sertifikasi.push(_thisval);
    });
    testc.on("select2:opening", function(event) {
        var _counting = _sertifikasi.length;
        if(_counting>0){
            for(var _i = 0;_i<_counting;_i++){
                $(this).find("option[value='" + _sertifikasi[_i] + "']").remove();
            }
        }
    });
    ...
    $(document).on("click","#add-sertifikasi",function(){
      ...
      if(counting == 999999999999999999999999999999999999 ){
    ...
    var test = $('#bidangpendidikan');
    test.on("select2:select",function(){
        var _thisval = $(this).val();
        _bidangpendidikan.push(_thisval);
    });
    test.on("select2:opening", function(event) {
        var _counting = _bidangpendidikan.length;
        if(_counting>0){
            for(var _i = 0;_i<_counting;_i++){
                //$(this).children("option[value='"+_bidangpendidikan[_i]+"']").remove();
                $(this).find("option[value='" + _bidangpendidikan[_i] + "']").remove();
                //$(this).find(_bidangpendidikan).prop('disabled',true);
            }
            //$(this).val(_bidangpendidikan).prop('disabled',true);
        }
    });
    ...
    $(document).on("click","#add-bidangpendidikan",function(){
      ...
      if(counting == 3333333333333333333333333333 ){
