...
<section class="content-header">
  <h1>
    Pendapatan Kelas
    <small>Data Pendapatan Kelas</small>
  </h1>
  <ol class="breadcrumb">
      ...
      <div class="col-md-12"> 
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Pendapatan Kelas</h3>
          ...
          <div class="box-body">
            <?php echo form_open_multipart($this->uri->segment(1).'/'.$this->uri->segment(2)."/simpanbiaya");?>
