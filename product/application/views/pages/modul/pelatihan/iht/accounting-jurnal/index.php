...
<section class="content-header">
  <h1>
    Pembukuan Kelas Reguler
    <small>Data Pembukuan Kelas Reguler</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="<?=base_url("dashboard")?>"><i class="fa fa-dashboard"></i> <?=$breadcrumb1?></a></li>
    <li><a>Kelas Pelatihan</a></li>
...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Manage Pembukuan Kelas Reguler</h3>
      ...
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            ...
            <th>ID Kelas</th>
            <th>Angkatan</th>
            <th width="250px">Jenis Pelatihan</th>
            <th>Tanggal</th>
          </tr>
        </thead>
        <tbody>
