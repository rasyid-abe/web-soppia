  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pengadaan-inventaris')){ ?>
        ...
        <?php }?>
        <?php if(accessperm('mengimport-data-pengadaan-inventaris')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pengadaan-inventaris')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
