  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-pemeliharaan-inventaris')){ ?>
        ...
        <?php }?>
        <!--<?php if(accessperm('mengimport-data-pemeliharaan-inventaris')){ ?>        
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-pemeliharaan-inventaris')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
