...
<section class="content">
  ...
  <div class="row">
    <form action="<?=base_url($this->uri->segment(1).'/'.$this->uri->segment(2)."/update/".$dtdefault->id_pinjam)?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="box-body">
            ...
            <div class="form-group col-sm-12">
                ...
                <div class="col-sm-10">
                  <select name="id_anggota" class="form-control select2" style="width: 100%;">
                    ...
                    foreach ($id_anggota->result() as $data) {
                      $slc = ($dtdefault->id_anggota==$data->id_anggota)? 'selected':'';
                    ?>
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-10">
                  <select name="id_buku" class="form-control select2" style="width: 100%;">
                    <option value="" readonly disabled selected>Pilih Buku</option>
                    <?php
                    foreach ($id_buku->result() as $data) {
                      $slc = ($dtdefault->id_buku==$data->id_buku)? 'selected':'';
                    ?>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="number" min="1" class="form-control" name="jml_pinjam" id="jml_pinjam" value="<?=$dtdefault->jml_pinjam?>" >
              </div>
            </div>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control" name="tgl_pinjam" id="tgl_pinjam" value="<?=$dtdefault->tgl_pinjam?>" readonly >
              </div>
            </div>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control" name="tgl_kembali" id="tgl_kembali" value="<?=$dtdefault->tgl_kembali?>" readonly >
              </div>
            </div>
