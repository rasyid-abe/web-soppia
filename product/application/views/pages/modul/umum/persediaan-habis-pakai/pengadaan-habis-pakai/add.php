        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="Desc_Consumables" id="Desc_Consumables" placeholder="Deskripsi Consumables"><?=$this->session->flashdata('oldinput')['Desc_Consumables']?></textarea>
              </div>
            </div>
              ...
              <div class="col-sm-10">
                ...
                <select name="FKd_Lokasi_Simpan" class="form-control select2" style="width: 100%;">
                  ...
                  foreach ($FKd_Lokasi_Simpan->result() as $data) {
                    $slc = ($this->session->flashdata('oldinput')['FKd_Lokasi_Simpan']==$data->Kd_Lokasi_Simpan)? 'selected':'';
                  ?>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control date" name="Tgl_PengadaanPertama" id="Tgl_PengadaanPertama" placeholder="Tanggal Pengadaan Pertama" value="<?=$this->session->flashdata('oldinput')['Tgl_PengadaanPertama']?>"  >
              </div>
            </div>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="Saldo" id="Saldo" onkeyup="splitInDots(this)" placeholder="Saldo" value="<?=$this->session->flashdata('oldinput')['Saldo']?>" >
              </div>
            </div>
