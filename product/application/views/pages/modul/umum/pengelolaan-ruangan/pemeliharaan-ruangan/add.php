        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="alasan_perbaikan" placeholder="Keterangan Pemeliharaan / Perbaikan"><?=$this->session->flashdata('oldinput')['alasan_perbaikan']?></textarea>
              </div>
            </div>
            ...
            <div class="form-group col-sm-12">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="biaya" onkeyup="splitInDots(this)" placeholder="Biaya Pemeliharaan" value="<?=$this->session->flashdata('oldinput')['biaya']?>" >
              </div>
            </div>
