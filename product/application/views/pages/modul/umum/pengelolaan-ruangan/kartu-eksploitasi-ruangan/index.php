       ...
       <thead>
        ...
        <tbody>
         <tr>
          ...
          <td>4646156</td>
          <td>Inventaris</td>
          <td>06/01/2018 - 10/11/2018</td>
          <td>06/01/2018 - 10/12/2018</td>
          <td>
            <a href='<?= base_url("pengelolaan-ruangan/kartu-eksploitasi-ruangan/view/4646156")?>' class='btn btn-xs btn-primary view-data' data-toggle='tooltip' title='View Data'> <i class='fa fa-search-plus'></i> View </a>
          </td>
        </tr>
        </tbody>
      </table>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-katru-eksploitasi-ruangan')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
