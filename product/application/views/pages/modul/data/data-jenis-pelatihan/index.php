  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-data-jenis-pelatihan')){ ?>
        ...
        <?php }?>
        <button type="button" class="btn btn-box-tool" data-toggle="tooltip" title="Refresh Page" onclick='location.reload();'><i class="fa fa-refresh"></i> Refresh</button>
      </div>
    </div>
    <div class="box-body">
<div class="table-responsive">
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            <th>No</th>
            <th style="width:200px">Nama Jenis Pelatihan</th>
            <th>Tingkatan Pelatihan</th>
            <th>Kelompok Pelatihan</th>
            <th>IHT</th>
            <th>QIA</th>
            <th>Default Awal QIA</th>
            <th>Action</th>
          </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "scrollX": true,
      "order": [], 
      <?php if(accessperm('mengekspor-data-data-jenis-pelatihan')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
