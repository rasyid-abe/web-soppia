  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <?php if(accessperm('menambahkan-data-materi-dan-aktifitas')){ ?>
...
<div class="table-responsive">
      <table class="table table-bordered table-striped dt-table" style="width: 100%">
        <thead>
          <tr>
            <th>No</th>
            <th style="160px">Nama Materi / Aktifitas</th>
            <th>Singkatan</th>
            <th>Skor</th>
            <th>Daftar Nilai</th>
            <th>Menit Per Sesi</th>
            <th>Action</th>
          </tr>
        </thead>
        <tbody>
...
<script type="text/javascript">  
  $(function () {
    ...
    $('table.dt-table').DataTable({
      ...
      "serverSide": true, 
      "order": [], 
      <?php if(accessperm('mengekspor-data-materi-dan-aktifitas')){ ?>
      "dom": 'Bfrtip',
      "buttons": [
