...
class Rpenutupankelas_model extends CI_Model {
	var $table = 'trm_pembukaankelas_n_angkatan'; 
    var $column_order = array(null,'trm_pembukaankelas_n_angkatan.DescBebas_Kelas_n_Angkatan','trm_pembukaankelas_n_angkatan.nomor_kelas','mst_pershinstansi.Desc_PershInstansi','trm_pembukaankelas_n_angkatan.Flag_Selesai'); 
    var $column_search = array('trm_pembukaankelas_n_angkatan.DescBebas_Kelas_n_Angkatan','trm_pembukaankelas_n_angkatan.nomor_kelas','mst_pershinstansi.Desc_PershInstansi','trm_pembukaankelas_n_angkatan.Flag_Selesai'); 
    ...
    public function getrecordjoin($id){
        $this->db->from($this->table);
        $this->db->select("trm_pembukaankelas_n_angkatan.*,mst_jenispelatihan.Desc_JenisPelatihan,mst_pershinstansi.Desc_PershInstansi,ref_kotatraining.Desc_KotaTraining,mst_formatpiagamsertifikat.Desc_Piagam_Sertifikat");
