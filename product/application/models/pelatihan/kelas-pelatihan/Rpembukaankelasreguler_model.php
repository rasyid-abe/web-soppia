...
class Rpembukaankelasreguler_model extends CI_Model {
	var $table = 'trm_pembukaankelas_n_angkatan'; 
    var $column_order = array(null,'trm_pembukaankelas_n_angkatan.DescBebas_Kelas_n_Angkatan','trm_pembukaankelas_n_angkatan.nomor_kelas','trm_pembukaankelas_n_angkatan.No_Urut_Angkatan','mst_jenispelatihan.Desc_JenisPelatihan'); 
    var $column_search = array('trm_pembukaankelas_n_angkatan.DescBebas_Kelas_n_Angkatan','trm_pembukaankelas_n_angkatan.nomor_kelas','trm_pembukaankelas_n_angkatan.No_Urut_Angkatan','mst_jenispelatihan.Desc_JenisPelatihan'); 
    var $order = array('trm_pembukaankelas_n_angkatan.nomor_kelas' => 'desc'); 
    ...
    {         
        ...
        ->where('trm_pembukaankelas_n_angkatan.idskreguler !=',"")
        ->from($this->table);
    ...
    public function getrecordjoin($id){
        ...
        $this->db->where('trm_pembukaankelas_n_angkatan.idskreguler !=',"");
        $this->db->where(array('Id_Kelas_n_Angkatan'=>$id));
        return $this->db->get()->row();        
    }
