...
class Rbukakunciankelas_model extends CI_Model {
 
    var $table = 'mst_peserta'; //nama tabel dari database
    var $column_order = array(null,null,'ABS(mst_peserta.NIPP)','mst_peserta.NamaPershInstansi','mst_peserta.NamaLengkap_TanpaGelar'); 
    var $column_search = array('ABS(mst_peserta.NIPP)','mst_peserta.NamaPershInstansi','mst_peserta.NamaLengkap_TanpaGelar'); 
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->where_in("Flag_SebabTerkunci",array("K"))
    ...
    public function getrecordjoin($id){
        $this->db->from('mst_peserta_dgn_ds_qia');
