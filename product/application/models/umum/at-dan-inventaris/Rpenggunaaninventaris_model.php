...
class Rpenggunaaninventaris_model extends CI_Model {
  
    var $table = 'trm_kartueksploit_atninvent'; 
    var $column_order = array(null,'Tgl_TransaksiAwal','Tgl_TransaksiAkhir','Desc_Transaksi','Flag_JnsTransaksi','PenanggungJwb','FId_ATnInvent','Keterangan');
    var $column_search = array('Tgl_TransaksiAwal','Tgl_TransaksiAkhir','Desc_Transaksi','Flag_JnsTransaksi','PenanggungJwb','FId_ATnInvent','Keterangan'); 
